...
public static class CliRunner
{
    ...
    private static CliOptions? ParseArgs(string[] args)
    {
        ...
        if (string.IsNullOrEmpty(opts.HtmlOutput))
        {
            ...
            opts.HtmlOutput = Path.Combine(desktop, $"NTFS_Permissions_{DateTime.Now:yyyyMMdd_HHmmss}.html");
        }
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine("  NTFSReport.exe --path <path> [options]");
        Console.WriteLine();
        ...
        Console.WriteLine(@"  NTFSReport.exe --path \\server\share --output report.html --depth 3");
        Console.WriteLine(@"  NTFSReport.exe --path C:\Shares --exclude-system --csv perms.csv --open");
    }
    ...
    private static void WriteBanner()
    {
        ...
        Console.WriteLine("================================================================");
        Console.WriteLine("  ProDirt NTFS Permissions Reporter v1.0");
        Console.WriteLine("================================================================");
        Console.ResetColor();
        Console.WriteLine();
    }
    ...
    private static string ResolveOutput(string user, string scanRoot, string ext)
    {
        ...
        if (Directory.Exists(user))
            return Path.Combine(user, $"NTFS_Permissions_{DateTime.Now:yyyyMMdd_HHmmss}{ext}");
